...
<template>
    <div class="min-h-screen flex flex-col">
        ...
        <!-- Nav superior -->
        <nav class="h-16  border-b flex items-center px-4 fixed top-0 left-16 right-0 z-10 bg-color-primary">
            <div>
        ...
        <div class="flex flex-1 pt-16">
                ...
                <div class=" flex flex-col items-center gap-y-6 w-full">
                    ...
                    <nav class="flex flex-col gap-y-4 w-full items-center">
                        <template v-for="item in navItems" :key="item.name">
                            ...
                            <Link v-if="item.route" :href="route(item.route)" :class="buttonClass" :title="item.name">
            ...
            <main class="ml-16 pt-0 flex-1 p-1">
                <slot />
            </main>
